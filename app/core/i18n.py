...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "vision_model.label": {"ru": "Vision-модель", "en": "Vision model"},
    "model.manual_option": {"ru": "Ввести вручную", "en": "Enter manually"},
    "model.manual_label": {"ru": "Свой {target}", "en": "Custom {target}"},
    ...
    "provider_status.provider": {"ru": "провайдер", "en": "provider"},
    "provider_status.reachable": {"ru": "доступен", "en": "reachable"},
    "provider_status.active_model": {"ru": "активная модель", "en": "active model"},
    "provider_status.vision_model": {"ru": "vision-модель", "en": "vision model"},
    "provider_status.reason": {"ru": "причина", "en": "reason"},
    "reason.active_ollama_model": {
        "ru": "Выбрана активная модель из /api/ps",
        "en": "Active model from /api/ps is selected",
    },
    "reason.default_model": {"ru": "Применен выбор модели по умолчанию", "en": "Default model selection applied"},
    "reason.openrouter_key_missing": {"ru": "OPENROUTER_API_KEY не задан", "en": "OPENROUTER_API_KEY is not set"},
    "reason.openrouter_fallback": {"ru": "Настроен fallback через OpenRouter", "en": "Configured OpenRouter fallback"},
    "reason.ollama_unavailable": {"ru": "Ollama недоступна", "en": "Ollama unavailable"},
    ...
    "workspace.delete": {"ru": "Удалить базу", "en": "Delete workspace"},
    "workspace.deleted": {"ru": "База удалена.", "en": "Workspace deleted."},
    "workspace.delete_failed": {"ru": "Не удалось удалить базу: {error}", "en": "Failed to delete workspace: {error}"},
